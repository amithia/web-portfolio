...
window.PROJECTS = [
  ...
  // },
  {
    ...
    tone: 'bubble', label: 'UX', meta: 'UI/UX · Mobile App · Start-up · 2024',
  ...
  },
  {
    ...
    tone: 'moss', label: 'UNI', meta: 'UI/UX · Mobile App · Research · 2024',
...
window.PRACTICES = [
  {
    ...
    methods: [
      ...
      { name: 'Deployment & tooling', detail: 'Shipping to production via Vercel, managing version control and keeping builds clean.' },
  ...
  },
  {
    ...
    methods: [
      ...
      { name: 'Data visualisation', detail: 'Charts and graphs that communicate a finding rather than just displaying numbers.' },
      { name: 'SQL & querying', detail: 'Pulling, joining and cleaning data from relational databases.' },
    ],
    relatedProjectIds: [6],
  },
  {
...
window.LEARNING = [
  ...
  },
  {
    ...
    status: 'active',
    progress: 50,
    desc: 'Eight courses covering the full data analytics workflow, asking the right questions, cleaning data, running analysis, and presenting findings using SQL, R, and Tableau.',
    lede: 'Formalising my data practice through Google\'s structured analytics curriculum — SQL, R, Tableau, and a capstone applying the full workflow to a real dataset.',
    tone: 'moss', glyph: null,
    sections: [
      { kind: 'block', tag: 'What it covers', title: 'The full analytics workflow, end to end.',
        body: [
          'Eight courses moving from foundations through to a capstone project. The curriculum covers the complete analyst process: asking the right questions, preparing and cleaning data, running analysis and communicating findings clearly.',
          { type: 'ul', items: [
            'Data cleaning: handling messy, incomplete data with spreadsheets and SQL',
            'SQL: filtering, joining and aggregating across relational datasets',
            'R:data wrangling with tidyverse and visualisation with ggplot2',
            'Power BI — building dashboards that communicate findings to non-technical stakeholders',
          ]},
        ],
      },
      { kind: 'metrics', items: [
        ...
        { num: 'Power BI', label: 'Visualisation' },
        { num: '50%', label: 'Progress to date' },
      ]},
      { kind: 'block', tag: 'Why this cert', title: 'Rigour over intuition.',
        body: 'This certificate is about reversing that: learning the full workflow deliberately and filling in the gaps. SQL and R\'s tidyverse are the two areas I am focused on getting properly rigorous about, since they underpin everything else in the stack.',
      },
    ],
  },
  // {
