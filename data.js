...
window.PRACTICES = [
  ...
  },
  {
    ...
    short: 'Building AI-powered features into real products including NLP analysis tools, conversational interfaces and intelligent recommendations.',
    tools: 'Claude API · Python · LangChain',
    lede: 'The best AI feature is the one that disappears into the product.',
    body: 'I build AI features that solve specific, real problems rather than demos for the sake of novelty. Projects include NLP-driven narrative analysis, AI-powered recipe suggestions in a shared living app and conversational interfaces built on the Claude API. I\'m drawn to the integration layer: where a model\'s capability meets a real user need in a product that just works.',
    methods: [
      { name: 'NLP & text analysis', detail: 'Named entity recognition, sentiment analysis and narrative pattern extraction.' },
      { name: 'LLM integration', detail: 'Building conversational and generative features using Claude API and LangChain.' },
      { name: 'AI feature design', detail: 'Designing the user-facing layer so AI outputs feel natural, not robotic.' },
      { name: 'Responsible AI', detail: 'Building in transparency, honest capability boundaries and graceful fallbacks.' },
    ],
