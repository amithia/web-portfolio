...
window.PRACTICES = [
  ...
  },
  {
    ...
    short: 'Building AI-powered features into real products — from NLP analysis tools to conversational interfaces and intelligent recommendations.',
    tools: 'Claude API · Python · LangChain',
    lede: 'The best AI feature is the one that disappears into the product.',
    body: 'I build AI features that solve specific, real problems — not demos for the sake of novelty. Projects include NLP-driven narrative analysis, AI-powered recipe suggestions in a shared living app, and conversational interfaces built on the Claude API. I\'m drawn to the integration layer: where a model\'s capability meets a real user need in a product that just works.',
    methods: [
  ...
  },
  {
    ...
    short: 'Analysis, dashboards, and statistical tools that help people make better decisions — not just prettier charts.',
    ...
    methods: [
      { name: 'Statistical analysis', detail: 'A/B testing, significance testing, regression — interpreted honestly, not just correctly.' },
